...
var $author$project$Types$AnswerCollectionEnded = function (a) {
	return {$: 'AnswerCollectionEnded', a: a};
};
var $author$project$Types$ChatForwarded = F2(
	function (a, b) {
		return {$: 'ChatForwarded', a: a, b: b};
	});
var $author$project$Types$ChatPage = {$: 'ChatPage'};
var $author$project$Types$ChatSent = function (a) {
	return {$: 'ChatSent', a: a};
};
var $author$project$Types$Feedback = F3(
	function (a, b, c) {
		return {$: 'Feedback', a: a, b: b, c: c};
	});
var $author$project$Types$FeedbackReceived = F3(
	function (a, b, c) {
		return {$: 'FeedbackReceived', a: a, b: b, c: c};
	});
var $author$project$Types$Finished = F2(
	function (a, b) {
...
var $author$project$Types$JoinConfirmed = {$: 'JoinConfirmed'};
var $author$project$Types$Joined = {$: 'Joined'};
...
var $author$project$Types$Disconnected = {$: 'Disconnected'};
...
var $author$project$Types$Auto$decodeMaybe = function (arga) {
	return A2(
		$elm$json$Json$Decode$andThen,
		function (word) {
			switch (word) {
				...
				case 'Just':
					return A3(
						$elm$json$Json$Decode$map2,
						$elm$core$Basics$apR,
						A2($elm$json$Json$Decode$index, 1, arga),
						$elm$json$Json$Decode$succeed($elm$core$Maybe$Just));
				default:
					return $elm$json$Json$Decode$fail('Unexpected Maybe: ' + word);
			}
		},
...
var $author$project$Types$Auto$decodeTypesPeerMsg = A2(
	...
	function (word) {
		switch (word) {
			...
			case 'Types.FeedbackReceived':
				return A3(
					$elm$json$Json$Decode$map2,
					$elm$core$Basics$apR,
					A2($elm$json$Json$Decode$index, 3, $author$project$Types$Auto$decodeInt),
					A3(
						$elm$json$Json$Decode$map2,
						$elm$core$Basics$apR,
						A2($elm$json$Json$Decode$index, 2, $author$project$Types$Auto$decodeTypesLeaderboard),
						A3(
							$elm$json$Json$Decode$map2,
							$elm$core$Basics$apR,
							A2($elm$json$Json$Decode$index, 1, $author$project$Types$Auto$decodeTypesQuestion),
							$elm$json$Json$Decode$succeed($author$project$Types$FeedbackReceived))));
			case 'Types.QuizFinished':
				return A3(
					$elm$json$Json$Decode$map2,
					$elm$core$Basics$apR,
					A2(
						$elm$json$Json$Decode$index,
						2,
						$author$project$Types$Auto$decodeMaybe($author$project$Types$Auto$decodeString)),
					A3(
						$elm$json$Json$Decode$map2,
						$elm$core$Basics$apR,
						A2($elm$json$Json$Decode$index, 1, $author$project$Types$Auto$decodeTypesLeaderboard),
						$elm$json$Json$Decode$succeed($author$project$Types$QuizFinished)));
			case 'Types.ChatSent':
				return A3(
					$elm$json$Json$Decode$map2,
					$elm$core$Basics$apR,
...
var $author$project$Types$Auto$encodeMaybe = F2(
	function (arga, value) {
		if (value.$ === 'Nothing') {
			return A2(
				$elm$json$Json$Encode$list,
				...
				_List_fromArray(
					[
						$author$project$Types$Auto$encodeString('Nothing')
					]));
		} else {
			var m0 = value.a;
			return A2(
				...
				_List_fromArray(
					[
						$author$project$Types$Auto$encodeString('Just'),
						arga(m0)
					]));
		}
	});
...
var $author$project$Types$Auto$encodeTypesLeaderboard = function (value) {
	return A2($author$project$Types$Auto$encodeDictDict, $author$project$Types$Auto$encodeTypesPeer, $author$project$Types$Auto$encodeInt)(value);
};
	...
	switch (value.$) {
		...
		case 'FeedbackReceived':
			...
			return A2(
				...
				_List_fromArray(
					[
						$author$project$Types$Auto$encodeString('Types.FeedbackReceived'),
						$author$project$Types$Auto$encodeTypesQuestion(m0),
						$author$project$Types$Auto$encodeTypesLeaderboard(m1),
						$author$project$Types$Auto$encodeInt(m2)
					]));
		case 'QuizFinished':
			var m0 = value.a;
			var m1 = value.b;
			return A2(
				...
				_List_fromArray(
					[
						$author$project$Types$Auto$encodeString('Types.QuizFinished'),
						$author$project$Types$Auto$encodeTypesLeaderboard(m0),
						A2($author$project$Types$Auto$encodeMaybe, $author$project$Types$Auto$encodeString, m1)
					]));
		case 'ChatSent':
			var m0 = value.a;
			return A2(
...
var $author$project$Shared$sum = A2($elm$core$List$foldl, $elm$core$Basics$add, 0);
var $author$project$Update$extractRatings = A2(
	$elm$core$Basics$composeR,
	$elm$core$Maybe$map(
		A2(
			$elm$core$Basics$composeR,
			...
			A2(
				...
				$elm$core$Dict$map(
					F2(
						function (_v0, a) {
							return $author$project$Shared$sum(
								$elm$core$Dict$values(a.ratings));
						})),
				$elm$core$Dict$toList))),
...
var $author$project$Update$leaderboard = function (h) {
	return A2(
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'peer',
					$elm$json$Json$Encode$string($.peer)),
					_Utils_Tuple2(
					'value',
					...
					return $elm$core$Maybe$Just(
						{
							answers: A2(
								...
								peer,
								{answer: a, ratings: $elm$core$Dict$empty}),
							order: $elm$core$Dict$size(h)
						});
				} else {
					var order = v.a.order;
					var answers = v.a.answers;
					return $elm$core$Maybe$Just(
						{
							answers: A3(
		...
		switch (msg.$) {
			case 'ToPeer':
				...
				return _Utils_Tuple2(
					...
					$author$project$Ports$toPeer(
						{
							peer: peer,
							value: $author$project$Types$Auto$encodeTypesPeerMsg(peerMsg)
						}));
			case 'FromPeer':
				var peer = msg.a;
				var value = msg.b;
								...
								if (_v1.a.$ === 'Host') {
									...
									return _Utils_Tuple2(
										...
										$author$project$Ports$toPeer(
											{
												peer: peer,
												value: $author$project$Types$Auto$encodeTypesPeerMsg($author$project$Types$JoinConfirmed)
											}));
								} else {
									break _v1$11;
								}
								...
								if (_v1.a.$ === 'Host') {
															...
															$elm$core$Maybe$map(
																function (b) {
																	return _Utils_update(
																		b,
																		{
																			ratings: A3($elm$core$Dict$insert, peer, rating, b.ratings)
																		});
																}),
															a.answers)
													});
									...
									return _Utils_Tuple2(
										_Utils_update(
											model,
											{
												role: A2($author$project$Types$Host, newHistory, guests)
											}),
													...
													return $author$project$Ports$toPeer(
														{
															...
															value: $author$project$Types$Auto$encodeTypesPeerMsg(
																A3(
																	$author$project$Types$FeedbackReceived,
																	question,
																	$author$project$Update$leaderboard(newHistory),
																	ratings))
														});
												},
												$author$project$Update$extractRatings(
													A2($elm$core$Dict$get, question, newHistory)))) : $elm$core$Platform$Cmd$none);
								} else {
									break _v1$11;
								}
							case 'QuizFinished':
								...
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											quiz: A2($author$project$Types$Finished, l, m)
										}),
									$elm$core$Platform$Cmd$none);
							case 'FeedbackReceived':
								if (_v1.a.$ === 'Guest') {
									...
									return _Utils_Tuple2(
										_Utils_update(
											model,
											{
												quiz: A3($author$project$Types$Feedback, q, l, rating)
											}),
										$elm$core$Platform$Cmd$none);
								} else {
									break _v1$11;
								...
								if (_v1.a.$ === 'NotSelected') {
									...
									return _Utils_Tuple2(
										_Utils_update(
											model,
											{
												role: $author$project$Types$Guest(peer)
											}),
										$elm$core$Platform$Cmd$none);
								} else {
									break _v1$11;
								...
								if (_v1.a.$ === 'Host') {
									...
									return _Utils_Tuple2(
										...
										$elm$core$Platform$Cmd$batch(
											A2(
												$elm$core$List$cons,
												$author$project$Ports$scrollDown(_Utils_Tuple0),
												A2(
													$elm$core$List$map,
													function (g) {
														return $author$project$Ports$toPeer(
			...
			case 'HostTyped':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							typedHost: $elm$core$Maybe$Just(a)
						}),
					$elm$core$Platform$Cmd$none);
				...
				if (_v19.$ === 'Just') {
					...
					return _Utils_Tuple2(
						...
						$author$project$Ports$toPeer(
							{
								peer: a,
								value: $author$project$Types$Auto$encodeTypesPeerMsg($author$project$Types$Joined)
							}));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'QuizHosted':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							role: A2($author$project$Types$Host, $elm$core$Dict$empty, _List_Nil)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ShowDrawer':
				return _Utils_Tuple2(
					...
					if (nextQuestion.$ === 'Just') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								...
								{
									quiz: A2(
										$author$project$Types$Finished,
										$author$project$Update$leaderboard(history),
										$elm$core$Maybe$Nothing)
								}),
							$elm$core$Platform$Cmd$batch(
								A2(
										...
										return $author$project$Ports$toPeer(
											{
												...
												value: $author$project$Types$Auto$encodeTypesPeerMsg(
													A2(
														$author$project$Types$QuizFinished,
														$author$project$Update$leaderboard(history),
														$elm$core$Maybe$Nothing))
											});
									},
							...
							case 'Guest':
								...
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											quiz: $author$project$Types$Loading(q)
										}),
									(model.typedAnswer === '') ? $elm$core$Platform$Cmd$none : $author$project$Ports$toPeer(
										{
											peer: host,
											value: $author$project$Types$Auto$encodeTypesPeerMsg(
											...
											$elm$core$Maybe$map(
												function (a) {
													return _Utils_update(
														a,
														{
															rating: $elm$core$Maybe$Just(rating)
														});
												}),
											rs));
								} else {
			...
			case 'ShowQuestions':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{drawerShown: false, page: $author$project$Types$QuestionsPage}),
					$elm$core$Platform$Cmd$none);
			case 'QuestionTyped':
				var a = msg.a;
				return _Utils_Tuple2(
			...
			case 'ShowChat':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{drawerShown: false, page: $author$project$Types$ChatPage}),
					$author$project$Ports$scrollDown(_Utils_Tuple0));
			case 'ChatTyped':
				var a = msg.a;
				return _Utils_Tuple2(
			...
			case 'ChatSubmitted':
				return _Utils_Tuple2(
					...
					$author$project$Ports$toPeer(
						{
							peer: $author$project$Update$hostId(model),
							value: $author$project$Types$Auto$encodeTypesPeerMsg(
								$author$project$Types$ChatSent(model.typedChat))
						}));
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Types$HideDrawer = {$: 'HideDrawer'};
var $author$project$Types$ShowChat = {$: 'ShowChat'};
var $author$project$Types$ShowDrawer = {$: 'ShowDrawer'};
var $author$project$Types$ShowHome = {$: 'ShowHome'};
var $author$project$Types$ShowQuestions = {$: 'ShowQuestions'};
...
var $author$project$Types$ChatSubmitted = {$: 'ChatSubmitted'};
var $author$project$Types$ChatTyped = function (a) {
	return {$: 'ChatTyped', a: a};
};
var $author$project$Types$QuestionSubmitted = {$: 'QuestionSubmitted'};
var $author$project$Types$QuestionTyped = function (a) {
	return {$: 'QuestionTyped', a: a};
};
			...
			[
				...
				_List_Nil,
				{
					primary: _List_fromArray(
						[
							$elm$html$Html$text(item.content)
						]),
...
var $author$project$Types$NextQuestionClick = {$: 'NextQuestionClick'};
...
var $author$project$View$rankToListItem = F2(
	function (model, _v0) {
		var peer = _v0.a;
		var score = _v0.b;
		return A2(
			...
			$aforemny$material_components_web_elm$Material$List$Item$config,
			function () {
				var stdattr = _List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'margin', '30px'),
						A2($elm$html$Html$Attributes$style, 'width', '100%')
					]);
				var attr = _Utils_eq(peer, model.name) ? A2(
					$elm$core$List$cons,
				...
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$elm$core$String$fromInt(score * 100))
							]))
					]);
			}());
	});
...
var $author$project$View$leaderboardList = F2(
	function (model, leaderboard) {
		var _v0 = A2(
			$elm$core$List$map,
			$author$project$View$rankToListItem(model),
			A2(
				...
				$elm$core$Dict$toList(leaderboard)));
		if (_v0.b) {
			var h = _v0.a;
			var t = _v0.b;
						...
						$aforemny$material_components_web_elm$Material$Card$config),
					{
						...
						blocks: _List_fromArray(
							[
								...
								$aforemny$material_components_web_elm$Material$Card$block(
								A3($aforemny$material_components_web_elm$Material$List$list, $aforemny$material_components_web_elm$Material$List$config, h, t))
							])
					}));
		} else {
...
var $author$project$Types$AnswerFocused = {$: 'AnswerFocused'};
var $author$project$Types$AnswerTyped = function (a) {
	return {$: 'AnswerTyped', a: a};
};
...
var $author$project$Types$Rated = F3(
	function (a, b, c) {
		return {$: 'Rated', a: a, b: b, c: c};
	});
var $aforemny$material_components_web_elm$Material$FormField$Config = function (a) {
	return {$: 'Config', a: a};
};
var $aforemny$material_components_web_elm$Material$FormField$config = $aforemny$material_components_web_elm$Material$FormField$Config(
...
var $aforemny$material_components_web_elm$Material$Radio$Config = function (a) {
	return {$: 'Config', a: a};
};
var $aforemny$material_components_web_elm$Material$Radio$config = $aforemny$material_components_web_elm$Material$Radio$Config(
...
var $aforemny$material_components_web_elm$Material$Radio$setChecked = F2(
	function (checked, _v0) {
		var config_ = _v0.a;
		return $aforemny$material_components_web_elm$Material$Radio$Config(
			_Utils_update(
				config_,
				{checked: checked}));
	});
var $aforemny$material_components_web_elm$Material$FormField$setLabel = F2(
	function (label, _v0) {
		var config_ = _v0.a;
		return $aforemny$material_components_web_elm$Material$FormField$Config(
			_Utils_update(
				config_,
				{label: label}));
	});
...
var $author$project$View$quizView = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				function () {
				var _v0 = _Utils_Tuple2(model.role, model.quiz);
				_v0$5:
				while (true) {
					if (_v0.a.$ === 'Host') {
						switch (_v0.b.$) {
										...
										[
											...
											_List_fromArray(
												[
													...
													$mdgriffith$elm_ui$Element$text(model.name)),
							...
							return A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$text('Waiting for the peer grading to start. (If you did not attempt to answer this question, then you will also skip the grading for this question.)')
											]))
									]));
						case 'Rating':
							var q = _v10.a;
								...
								_List_fromArray(
									[
										...
										A2(
											...
											'+' + $elm$core$String$fromInt(rating * 100))),
										A2($author$project$View$leaderboardList, model, leaderboard)
									]));
						default:
							var leaderboard = _v10.a;
							var msg = _v10.b;
							return A2(
								$mdgriffith$elm_ui$Element$column,
								_List_fromArray(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$text('Congratulations, ' + (model.name + '!')),
												$mdgriffith$elm_ui$Element$text(
												A2($elm$core$Maybe$withDefault, '', msg))
											])),
										A2($author$project$View$leaderboardList, model, leaderboard)
									]));
					}
								...
								A2(
									...
									A2(
										...
										A2(
											...
											A2(
												$aforemny$material_components_web_elm$Material$TextField$setValue,
												$elm$core$Maybe$Just(model.typedQuestion),
												$aforemny$material_components_web_elm$Material$TextField$config))))))
						]));
			} else {
				return A2(
							...
							A2(
								...
								A2(
									...
									A2(
										...
										A2(
											$aforemny$material_components_web_elm$Material$TextField$setValue,
											$elm$core$Maybe$Just(model.typedChat),
											$aforemny$material_components_web_elm$Material$TextField$config))))))
					]));
	}
};
...
var $aforemny$material_components_web_elm$Material$TopAppBar$setFixed = F2(
	function (fixed, _v0) {
		var config_ = _v0.a;
		return $aforemny$material_components_web_elm$Material$TopAppBar$Config(
			_Utils_update(
				config_,
				{fixed: fixed}));
	});
				...
				_List_fromArray(
					[
						...
						A2(
							...
							A2($aforemny$material_components_web_elm$Material$Drawer$Modal$setOpen, model.drawerShown, $aforemny$material_components_web_elm$Material$Drawer$Modal$config)),
						_List_fromArray(
							[
								A2(
...
var $author$project$Types$HostTyped = function (a) {
	return {$: 'HostTyped', a: a};
};
var $author$project$Types$QuizHosted = {$: 'QuizHosted'};
var $author$project$Types$QuizJoinRequested = {$: 'QuizJoinRequested'};
										...
										A2(
											...
											A2(
												...
												A2(
													...
													_Utils_eq(model.typedHost, $elm$core$Maybe$Nothing) || _Utils_eq(
														model.typedHost,
														$elm$core$Maybe$Just('')),
													$aforemny$material_components_web_elm$Material$Button$config))),
										'Join Quiz'))
